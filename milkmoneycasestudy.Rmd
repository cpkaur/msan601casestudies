...
## Initial Considerations
We started by looking at how SLR models work in predicting commodity values
when the Mailbox is fixed at $12.50, since this is the value that garners
Gerard's interest (see __Codeblock 9__ in the _Appendix_). Comparing these
predicted values with similar actual values in the data set, we see that
_Class.III_ and _Class.IV_ appear to correspond the best.  

## Determine the Predictor
With this in mind, we see which predictor is actually most closely related to
the mailbox price. As detailed above in the _Methods_ and _Results_ sections,
...
that the net price will exceed $12.50.  
...
put option at a value of $13.18 + fees.  
