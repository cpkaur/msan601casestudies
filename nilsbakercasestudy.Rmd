...
With the data in a usable form, we can now view the correlation matrix to get develop an initial understanding of the relationships amongst the variables.  
